...
namespace SIOMS.Areas.Admin.Controllers
{
    ...
    public class ProductController : AdminBaseController  // ✅ CHANGED: Inherits from AdminBaseController
    {
        ...
        public async Task<IActionResult> UpdateStock(int id, [FromBody] StockUpdateModel model)
        {
            try
            {
                ...
                int quantityChange = model.NewStock - oldStock;
                ...
                var movement = new StockMovement
                {
                    ...
                    Notes = string.IsNullOrEmpty(model.Notes) ? "Manual stock adjustment" : model.Notes,
                    MovementDate = DateTime.Now
                };
    ...
    // At the end of ProductController.cs - Fix the StockUpdateModel
    public class StockUpdateModel
    {
        public int NewStock { get; set; }
        public string? Notes { get; set; } = string.Empty; // ✅ Made nullable with default
    }
}